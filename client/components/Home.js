    ...
    return (
        <ScrollView style={{ backgroundColor: '#fafafb' }}>
            ...
            <View style={{ flexDirection: 'row', marginHorizontal: 15, justifyContent: 'center' }}>
                ...
                <TouchableOpacity style={{ flexDirection: 'row', width: '25%', alignItems: 'flex-end', borderWidth: 1, borderRadius: 15, borderColor: '#4bcfe0', paddingVertical: 10, paddingHorizontal: 5 }}>
            ...
            <View style={{ gap: 15, flexDirection: 'row', marginHorizontal: 15, marginTop: 10 }}>
                <TouchableOpacity style={{ width: '48%', borderRadius: 10, backgroundColor: '#1ce5ff', paddingVertical: 15 }}>
                    <View style={{ alignItems: 'flex-end' }}>
                        <MaterialCommunityIcons name="run" size={60} color="white" />
                    </View>
                    <View style={{ marginHorizontal: 5, gap: 5, paddingVertical: 15 }}>
                        <Text style={{ color: 'white', fontWeight: 'bold' }}>Steps</Text>
                        <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 20 }}>11,857</Text>
                        <Text style={{ color: 'white', fontWeight: 'bold' }}>updated 15 min ago</Text>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={{ width: '48%', borderRadius: 10, backgroundColor: '#e77e7e', paddingVertical: 15 }}>
                    <View style={{ alignItems: 'flex-end' }}>
                        <MaterialCommunityIcons name="calendar-month-outline" size={60} color="white" />
                    </View>
                    <View style={{ marginHorizontal: 5, gap: 5, paddingVertical: 15 }}>
                        <Text style={{ color: 'white', fontWeight: 'bold' }}>Cycle tracking</Text>
                        <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 15 }}>12 days before perio</Text>
                        <Text style={{ color: 'white', fontWeight: 'bold' }}>updated 30 min ago</Text>
                    </View>
                </TouchableOpacity>
            </View>
            <View style={{ gap: 15, flexDirection: 'row', marginHorizontal: 15, marginTop: 10 }}>
                <TouchableOpacity style={{ width: '48%', borderRadius: 10, backgroundColor: '#125d95', paddingVertical: 15 }}>
                    <View style={{ alignItems: 'flex-end' }}>
                        <MaterialCommunityIcons name="power-sleep" size={60} color="white" />
                    </View>
                    <View style={{ marginHorizontal: 5, gap: 5, paddingVertical: 15 }}>
                        <Text style={{ color: 'white', fontWeight: 'bold' }}>Sleep</Text>
                        <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 20 }}>7 h 31 min</Text>
                        <Text style={{ color: 'white', fontWeight: 'bold' }}>updated 8 day ago</Text>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={{ width: '48%', borderRadius: 10, backgroundColor: '#cc5f12', paddingVertical: 15 }}>
                    <View style={{ alignItems: 'flex-end' }}>
                        <MaterialCommunityIcons name="food-variant" size={60} color="white" />
                    </View>
                    <View style={{ marginHorizontal: 5, gap: 5, paddingVertical: 15 }}>
                        <Text style={{ color: 'white', fontWeight: 'bold' }}>Nutrition</Text>
                        <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 15 }}>960 kcal</Text>
                        <Text style={{ color: 'white', fontWeight: 'bold' }}>updated 5 min ago</Text>
                    </View>
                </TouchableOpacity>
            </View>
