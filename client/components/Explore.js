        ...
        <View style={{ flex: 1, backgroundColor: '#fafafb', justifyContent: 'space-between', }}>
            ...
            <ScrollView style={{ height: 600, flex: 1 }}>
                ...
                <ScrollView horizontal
                    ...
                    <TouchableOpacity style={{ backgroundColor: '#ebfdff', paddingHorizontal: 30, paddingVertical: 20, alignItems: 'center', borderRadius: 15 }}>
                        <FontAwesome6 name="bowl-food" size={50} color="black" />
                        <Text style={{ fontSize: 20, color: '#adbbbe' }}>Nutrition</Text>
                    </TouchableOpacity>
